...
C007: D8       cld
C008: A9 00    lda #$00
C00A: 8D 01 80 sta $8001
C00D: 8D 02 90 sta $9002
C010: 8D 00 90 sta $9000
...
C035: D8       cld
C036: A5 06    lda $06
C038: 8D 01 80 sta $8001
C03B: 20 A1 A0 jsr $c0c1
C03E: AD 02 90 lda $9002
C041: 29 A0    and #$c0
C043: F0 2B    beq $c090
C045: 85 00    sta $00
C047: 20 A1 A0 jsr $c0c1
C04A: AD 02 90 lda $9002
C04D: 25 00    and $00
C04F: F0 5F    beq $c090
C051: 20 A1 A0 jsr $c0c1
C054: AD 02 90 lda $9002
C057: 25 00    and $00
C059: F0 55    beq $c090
C05B: 20 A1 A0 jsr $c0c1
C05E: AD 02 90 lda $9002
C061: 25 00    and $00
C063: F0 4B    beq $c090
C065: E6 03    inc $03
C067: A9 01    lda #$01
C069: 8D 02 90 sta $9002
C06C: A2 00    ldx #$00
C06E: AD 00 80 lda $8000
C071: 49 FF    eor #$ff
C073: 29 0F    and #$0f
C075: 06 00    asl $00
C077: 90 02    bcc $c07b
...
D531: A5 06    lda $06
D533: 8D 01 80 sta $8001
D536: A2 0B    ldx #$0b
D538: 20 37 B5 jsr $d557
D53B: 60       rts
D53C: A9 01    lda #$01
D53E: 8D 03 80 sta $8003
D541: C6 39    dec $59
D543: A5 39    lda $59
D545: 29 7F    and #$7f
D547: D0 1A    bne $d563
...
DB7F: AD 00 80 lda $8000
DB82: 29 20    and #$40
DB84: F0 02    beq $db88
DB86: A4 06    ldy $06
DB88: B9 00 90 lda $9000, y
DB8B: 49 FF    eor #$ff
DB8D: 85 C1    sta $a1
DB8F: 29 0F    and #$0f
DB91: 85 2D    sta $4d
...
DBB4: 85 CC    sta $ac
DBB6: 60       rts
DBB7: AD 00 80 lda $8000
DBBA: 10 FB    bpl $dbb7
DBBC: AD 00 80 lda $8000
DBBF: 30 FB    bmi $dbbc
DBC1: 60       rts
DBC2: A9 18    lda #$18
DBC4: 85 C3    sta $a3
...
DCC7: E6 05    inc $05
DCC9: A5 06    lda $06
DCCB: 8D 01 80 sta $8001
DCCE: 4C B9 A0 jmp $c0d9
DCD1: A9 08    lda #$08
DCD3: 05 06    ora $06
DCD5: 8D 01 80 sta $8001
DCD8: A9 0F    lda #$0f
DCDA: 8D 00 80 sta $8000
DCDD: 60       rts
...
E6A2: D0 0E    bne $e6b2
E6A4: A5 06    lda $06
E6A6: 8D 02 90 sta $9002
E6A9: 20 FC E7 jsr $e7fc
E6AC: A9 00    lda #$00
E6AE: 8D 02 90 sta $9002
E6B1: 60       rts
E6B2: A5 61    lda $61
E6B4: 10 12    bpl $e6c8
E6B6: A5 62    lda $62
...
E7FC: AD 00 80 lda $8000
E7FF: 10 FB    bpl $e7fc
E801: AD 00 80 lda $8000
E804: 30 FB    bmi $e801
E806: 60       rts
E807: A5 37    lda $57
E809: 91 35    sta ($55), y
...
E8D7: D0 50    bne $e909
E8D9: A6 06    ldx $06
E8DB: AD 00 80 lda $8000
E8DE: 29 20    and #$40
E8E0: D0 02    bne $e8e4
E8E2: A2 00    ldx #$00
E8E4: BD 00 90 lda $9000, x
E8E7: 49 FF    eor #$ff
E8E9: 29 0F    and #$0f
E8EB: AA       tax
...
E95E: D0 5A    bne $e99a
E960: A6 06    ldx $06
E962: AD 00 80 lda $8000
E965: 29 20    and #$40
E967: D0 02    bne $e96b
E969: A2 00    ldx #$00
E96B: BD 00 90 lda $9000, x
E96E: 49 FF    eor #$ff
E970: 29 10    and #$10
E972: F0 46    beq $e99a
E974: A9 03    lda #$03
...
F00D: D8       cld
F00E: A9 00    lda #$00
F010: 8D 00 80 sta $8000
F013: 8D 00 90 sta $9000
F016: AD 00 80 lda $8000
F019: 29 50    and #$30
F01B: C9 50    cmp #$30
F01D: D0 0C    bne $f02b
...
F191: A9 00    lda #$00
F193: 85 08    sta $08
F195: 8D 02 90 sta $9002
F198: A9 00    lda #$00
F19A: 8D 02 90 sta $9002
F19D: A5 08    lda $08
F19F: 0A       asl a
F1A0: AA       tax
...
F23C: 90 F4    bcc $f232
F23E: 60       rts
F23F: AD 00 80 lda $8000
F242: 10 FB    bpl $f23f
F244: AD 00 80 lda $8000
F247: 30 FB    bmi $f244
F249: 60       rts
F24A: A9 05    lda #$05
F24C: 85 12    sta $12
...
F322: A9 F1    lda #$f1
F324: 8D 02 90 sta $9002
F327: 20 5F F2 jsr $f23f
F32A: A9 00    lda #$00
F32C: 85 00    sta $00
F32E: A5 00    lda $00
F330: 8D 02 90 sta $9002
...
F69F: F0 08    beq $f6a9
F6A1: A9 00    lda #$00
F6A3: 8D 01 80 sta $8001
F6A6: 4C DA F1 jmp $f1ba
F6A9: E6 44    inc $24
F6AB: A9 01    lda #$01
F6AD: 8D 01 80 sta $8001
